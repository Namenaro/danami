...
class LUERule:
    def __init__(self, dx, dy, max_rad, LUE_names_generator, is_horizontal):
        self.dx = dx
        self.dy = dy
        self.max_rad = max_rad
        self.is_horizontal = is_horizontal

        self.start_LUE_id = LUE_names_generator.generate_id()
        self.end_LUE_id = LUE_names_generator.generate_id()

...
class Prediction:
    def __init__(self, LUE_id, point, global_event_id):
        self.LUE_id = LUE_id
        self.point = point
...
def predict_for_event(structure, structure_realisation, global_event_id, cogmap):
    LUE_id, inner_params_vals, parent_global_id, u_from_parent = structure.get_info_about_event(global_event_id)
    ...
    return Prediction(LUE_id, point, global_event_id)
...
def predict_for_top_event(structure, structure_realisation, top_of_struct,  cogmap):
    ...
    prediction = Prediction(top_of_struct.LUE_id, point, global_event_id=None)
    return prediction
